...
files="main/views.py main/views_api.py main/models.py main/forms.py training/views.py training/models.py training/admin.py training/serializers.py main/admin.py main/signals.py"
